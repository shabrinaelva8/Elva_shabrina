...
try {
    ...
    $mail->Username   = 'elvashabrina1@gmail.com';                     //SMTP username
    $mail->Password   = 'zibt vcdj mlvi lhly';                               //SMTP password
    $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('elvashabrina1@gmail.com', 'saran');
    $mail->addAddress('elvashabrina1@gmail.com', 'shabrina');     //Add a recipient
